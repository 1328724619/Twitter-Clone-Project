...
const features = [
  "Priority rankings in conversation and search",
  ...
  "All the existing Tark features, including Edit posts, Bookmark folders and early access to new features",
];
            ...
            <div className="w-[80%] space-y-10">
              <div className="p-5 rounded-md flex items-center justify-between bg-slate-200 shadow-lg">
                <h1 className="text-xl pr-5">
                  Subscribers will get a Tark checkmark once approved
                </h1>
                <img
                  className="w-24 h-24"
                  src="https://www.svgrepo.com/show/68401/verification-symbol.svg"
                  alt=""
                />
              </div>
              ...
              <div className="cursor-pointer flex justify-center bg-gray-700 text-white rounded-full px-5 py-3">
                <span className="line-through italic">$20</span>
                <span className="px-5">$10/year</span>
              </div>
            </div>
          </div>
        </Box>
